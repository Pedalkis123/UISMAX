...
CreateElement("SlicedFrame", function(Color, Image, SliceScale)
	local Frame = Create("ImageLabel", {
		BackgroundTransparency = 1,
		Image = Image or "rbxassetid://7957105852", -- Rounded UI asset
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(NexusUI.Themes[NexusUI.SelectedTheme].Second.R * 255 + 3, NexusUI.Themes[NexusUI.SelectedTheme].Second.G * 255 + 3, NexusUI.Themes[NexusUI.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = NexusUI.Themes[NexusUI.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(NexusUI.Themes[NexusUI.SelectedTheme].Second.R * 255 + 6, NexusUI.Themes[NexusUI.SelectedTheme].Second.G * 255 + 6, NexusUI.Themes[NexusUI.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				function Toggle:Set(Value)
					Toggle.Value = Value
					TweenService:Create(ToggleBox, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Toggle.Value and ToggleConfig.Color or NexusUI.Themes.Default.Divider}):Play()
					TweenService:Create(ToggleBox.Stroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Color = Toggle.Value and ToggleConfig.Color or NexusUI.Themes.Default.Stroke}):Play()
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(NexusUI.Themes[NexusUI.SelectedTheme].Second.R * 255 + 3, NexusUI.Themes[NexusUI.SelectedTheme].Second.G * 255 + 3, NexusUI.Themes[NexusUI.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = NexusUI.Themes[NexusUI.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(NexusUI.Themes[NexusUI.SelectedTheme].Second.R * 255 + 6, NexusUI.Themes[NexusUI.SelectedTheme].Second.G * 255 + 6, NexusUI.Themes[NexusUI.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)

				if ToggleConfig.Flag then
					NexusUI.Flags[ToggleConfig.Flag] = Toggle
				end	
				return Toggle
			end  
			function ElementFunction:AddSlider(SliderConfig)
				...
				if SliderConfig.Flag then				
					NexusUI.Flags[SliderConfig.Flag] = Slider
				end
				return Slider
			end  
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				if DropdownConfig.Flag then				
					NexusUI.Flags[DropdownConfig.Flag] = Dropdown
				end
				return Dropdown
			end
			function ElementFunction:AddBind(BindConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(NexusUI.Themes[NexusUI.SelectedTheme].Second.R * 255 + 3, NexusUI.Themes[NexusUI.SelectedTheme].Second.G * 255 + 3, NexusUI.Themes[NexusUI.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = NexusUI.Themes[NexusUI.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(NexusUI.Themes[NexusUI.SelectedTheme].Second.R * 255 + 6, NexusUI.Themes[NexusUI.SelectedTheme].Second.G * 255 + 6, NexusUI.Themes[NexusUI.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
				...
				if BindConfig.Flag then				
					NexusUI.Flags[BindConfig.Flag] = Bind
				end
				return Bind
			end  
			function ElementFunction:AddTextbox(TextboxConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(NexusUI.Themes[NexusUI.SelectedTheme].Second.R * 255 + 3, NexusUI.Themes[NexusUI.SelectedTheme].Second.G * 255 + 3, NexusUI.Themes[NexusUI.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = NexusUI.Themes[NexusUI.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(NexusUI.Themes[NexusUI.SelectedTheme].Second.R * 255 + 6, NexusUI.Themes[NexusUI.SelectedTheme].Second.G * 255 + 6, NexusUI.Themes[NexusUI.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
			end 
			function ElementFunction:AddColorpicker(ColorpickerConfig)
				...
				if ColorpickerConfig.Flag then				
					NexusUI.Flags[ColorpickerConfig.Flag] = Colorpicker
				end
				return Colorpicker
			end  
			return ElementFunction   
