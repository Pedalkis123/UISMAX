...
function OverHeavenLib:MakeWindow(WindowConfig)
	...
	OverHeavenLib.Folder = WindowConfig.ConfigFolder
	OverHeavenLib.SaveCfg = WindowConfig.SaveConfig
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.R * 255 + 3, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.G * 255 + 3, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.R * 255 + 6, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.G * 255 + 6, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				AddConnection(Click.MouseLeave, function()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.R * 255 + 6, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.G * 255 + 6, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)

				if ToggleConfig.Flag then
					OverHeavenLib.Flags[ToggleConfig.Flag] = Toggle
				end	
				return Toggle
			end  
			function ElementFunction:AddSlider(SliderConfig)
				...
				if SliderConfig.Flag then				
					OverHeavenLib.Flags[SliderConfig.Flag] = Slider
				end
				return Slider
			end  
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				if DropdownConfig.Flag then				
					OverHeavenLib.Flags[DropdownConfig.Flag] = Dropdown
				end
				return Dropdown
			end
			function ElementFunction:AddBind(BindConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.R * 255 + 3, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.G * 255 + 3, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.R * 255 + 6, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.G * 255 + 6, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
				...
				if BindConfig.Flag then				
					OverHeavenLib.Flags[BindConfig.Flag] = Bind
				end
				return Bind
			end  
			function ElementFunction:AddTextbox(TextboxConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.R * 255 + 3, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.G * 255 + 3, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.R * 255 + 6, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.G * 255 + 6, OverHeavenLib.Themes[OverHeavenLib.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
			end 
			function ElementFunction:AddColorpicker(ColorpickerConfig)
				...
				if ColorpickerConfig.Flag then				
					OverHeavenLib.Flags[ColorpickerConfig.Flag] = Colorpicker
				end
				return Colorpicker
			end  
